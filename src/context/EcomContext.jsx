...
export const EcomProvider = ({ children }) => {
  ...
  const fetchProduct = async () => {
    const res = await fetch("https://startech-ecom-api-hgo9.onrender.com/api/product");
  ...
  const addToCart = async (productId) => {
    try {
      const res = await fetch("https://startech-ecom-api-hgo9.onrender.com/api/add-to-cart", {
        method: "POST",
        headers: {
  ...
  const fetchCart = async () => {
    try {
      const res = await fetch("https://startech-ecom-api-hgo9.onrender.com/api/cart", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "auth-token": `${localStorage.getItem("auth-token")}`,
  ...
  const updateQuantity = async (productId, quantity) => {
    ...
    try {
      const res = await fetch("https://startech-ecom-api-hgo9.onrender.com/api/update-quantity", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "auth-token": `${localStorage.getItem("auth-token")}`,
  ...
  const deleteItem = async (productId) => {
    try {
      const res = await fetch("https://startech-ecom-api-hgo9.onrender.com/api/remove-item", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "auth-token": `${localStorage.getItem("auth-token")}`,
  ...
  const createOrder = async (transaction_id, orderId) => {
    try {
      const response = await fetch("https://startech-ecom-api-hgo9.onrender.com/api/payment/verify", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "auth-token": `${localStorage.getItem("auth-token")}`,
